...
public class MbELNumericScaleConfigImpl extends MbELPsiCompositeElementBase implements MbELNumericScaleConfig {

  public MbELNumericScaleConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
