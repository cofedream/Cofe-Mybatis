...
public class MbELTypeHandlerConfigImpl extends MbELPsiCompositeElementBase implements MbELTypeHandlerConfig {

  public MbELTypeHandlerConfigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MbELVisitor visitor) {
    visitor.visitTypeHandlerConfig(this);
  }
