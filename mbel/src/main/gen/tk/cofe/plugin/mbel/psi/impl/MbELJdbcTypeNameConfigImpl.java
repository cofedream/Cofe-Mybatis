...
public class MbELJdbcTypeNameConfigImpl extends MbELPsiCompositeElementBase implements MbELJdbcTypeNameConfig {

  public MbELJdbcTypeNameConfigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MbELVisitor visitor) {
    visitor.visitJdbcTypeNameConfig(this);
  }
