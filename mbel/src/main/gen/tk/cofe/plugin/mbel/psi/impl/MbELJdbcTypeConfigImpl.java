...
public class MbELJdbcTypeConfigImpl extends MbELPsiCompositeElementBase implements MbELJdbcTypeConfig {

  public MbELJdbcTypeConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
