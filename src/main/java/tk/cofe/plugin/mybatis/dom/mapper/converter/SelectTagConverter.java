...
public class SelectTagConverter {
    ...
    public static class ResultMap extends XmlAttributeValueConverter<tk.cofe.plugin.mybatis.dom.mapper.model.tag.ResultMap> {
        @Nullable
        @Override
        ...
        @Override
        protected boolean filterDomElement(@NotNull tk.cofe.plugin.mybatis.dom.mapper.model.tag.ResultMap targetDomElement, @NotNull String selfValue) {
