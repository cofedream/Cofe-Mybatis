...
public class MapperXmlReferenceContributor extends PsiReferenceContributor {
    ...
    private static final XmlAttributeValuePattern CLASS_ELEMENT_RESULT_TYPE_PATTERN = XmlPatterns.xmlAttributeValue().withParent(RESULT_TYPE.withParent(CLASS_ELEMENT_PATTERN));

    @Override
    public void registerReferenceProviders(@NotNull PsiReferenceRegistrar registrar) {
        //registrar.registerReferenceProvider(XML_ATTRIBUTE_VALUE_PATTERN, new XmlAttributeValueReferenceProvider());
        registrar.registerReferenceProvider(CLASS_ELEMENT_ID_PATTERN, new IdAttributeReferenceProvider());
        registrar.registerReferenceProvider(CLASS_ELEMENT_RESULT_TYPE_PATTERN, new ResultTypeAttributeReferenceProvider());
    }
