...
public class MapperXmlReferenceContributor extends PsiReferenceContributor {
    ...
    private static final XmlAttributeValuePattern INCLUDE_ID_PATTERN = XmlPatterns.xmlAttributeValue()
            .withParent(XmlPatterns.xmlAttribute().withLocalName("refid")
                    .withParent(XmlPatterns.xmlTag().withLocalName("include")));
