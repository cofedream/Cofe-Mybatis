...
public abstract class MblExpressionImpl extends MblPsiCompositeElementBase implements MblExpression {

  public MblExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public @Nullable PsiType getType() {
    return MblPsiUtil.getType(this);
  }
