...
public class MblVariableExpressionImpl extends MblVariableExpressionBase implements MblVariableExpression {

  public MblVariableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
