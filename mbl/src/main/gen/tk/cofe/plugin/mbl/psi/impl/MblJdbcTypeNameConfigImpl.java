...
public class MblJdbcTypeNameConfigImpl extends MblPsiCompositeElementBase implements MblJdbcTypeNameConfig {

  public MblJdbcTypeNameConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
