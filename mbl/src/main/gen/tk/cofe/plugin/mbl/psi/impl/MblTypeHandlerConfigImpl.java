...
public class MblTypeHandlerConfigImpl extends MblPsiCompositeElementBase implements MblTypeHandlerConfig {

  public MblTypeHandlerConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
