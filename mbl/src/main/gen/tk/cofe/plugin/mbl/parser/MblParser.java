...
public class MblParser implements PsiParser, LightPsiParser {
  ...
  static boolean paramConfig(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, p, MblParser::configRecover);
    return r || p;
  }
  ...
  public static boolean parameterList(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, MblParser::parameterRecover);
    return r;
  }
  ...
  static boolean rootElement(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, MblParser::rootRecover);
    return r;
  }
  ...
  public static boolean referenceExpression(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, MblParser::referenceRecover);
    return r;
  }
