...
public class MblResultMapConfigImpl extends MblPsiCompositeElementBase implements MblResultMapConfig {

  public MblResultMapConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
