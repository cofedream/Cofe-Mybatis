...
public class MblLiteralExpressionImpl extends MblExpressionImpl implements MblLiteralExpression {

  public MblLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public @Nullable Object getConstantValue() {
    return MblPsiUtil.getConstantValue(this);
  }
