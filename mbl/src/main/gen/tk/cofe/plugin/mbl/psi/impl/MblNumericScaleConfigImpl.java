...
public class MblNumericScaleConfigImpl extends MblPsiCompositeElementBase implements MblNumericScaleConfig {

  public MblNumericScaleConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
