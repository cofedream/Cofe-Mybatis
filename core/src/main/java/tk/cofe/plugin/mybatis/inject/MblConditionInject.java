 ...
 * @date : 2019-10-26
 */
public class MblConditionInject extends BaseInjector implements DumbAware {

    public MblConditionInject() {
    ...
    void inject(@NotNull final MultiHostRegistrar registrar, @NotNull final PsiElement context) {
        ...
        MblLanguageInjector.injectWithPrefixSuffix(registrar, (PsiLanguageInjectionHost) context);
    }
