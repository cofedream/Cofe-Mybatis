...
public class MbspExpressionImpl extends MbspPsiCompositeElementBase implements MbspExpression {
  ...
  @Override
  @NotNull
  public List<MbspReferenceExpression> getReferenceExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MbspReferenceExpression.class);
  }
