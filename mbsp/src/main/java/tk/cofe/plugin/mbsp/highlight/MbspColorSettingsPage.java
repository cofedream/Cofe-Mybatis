 ...
 * @date : 2021-02-25
 */
public class MbspColorSettingsPage implements ColorSettingsPage {
    private static final AttributesDescriptor[] ATTRIBUTES_DESCRIPTORS = new AttributesDescriptor[]{
            new AttributesDescriptor("Parameter config keyword", MbspSyntaxHighlighter.KEYWORDS),
    };
    ...
    public @NotNull SyntaxHighlighter getHighlighter() {
        return new MbspSyntaxHighlighter();
    }
