...
public class MbspNumericScaleConfigImpl extends MbspPsiCompositeElementBase implements MbspNumericScaleConfig {

  public MbspNumericScaleConfigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MbspVisitor visitor) {
    visitor.visitNumericScaleConfig(this);
  }
