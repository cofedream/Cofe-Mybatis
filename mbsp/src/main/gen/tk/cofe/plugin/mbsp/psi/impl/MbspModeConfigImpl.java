...
public class MbspModeConfigImpl extends MbspPsiCompositeElementBase implements MbspModeConfig {

  public MbspModeConfigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MbspVisitor visitor) {
    visitor.visitModeConfig(this);
  }
