...
public class MbspJdbcTypeNameConfigImpl extends MbspPsiCompositeElementBase implements MbspJdbcTypeNameConfig {

  public MbspJdbcTypeNameConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
