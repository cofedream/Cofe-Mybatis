...
public class MbspParenthesizedExpressionImpl extends MbspExpressionImpl implements MbspParenthesizedExpression {

  public MbspParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
