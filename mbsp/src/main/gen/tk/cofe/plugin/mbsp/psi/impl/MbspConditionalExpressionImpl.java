...
public class MbspConditionalExpressionImpl extends MbspExpressionImpl implements MbspConditionalExpression {

  public MbspConditionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MbspExpression getCondition() {
