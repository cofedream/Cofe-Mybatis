...
public class MbspResultMapConfigImpl extends MbspPsiCompositeElementBase implements MbspResultMapConfig {

  public MbspResultMapConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
