...
public class MbspTypeHandlerConfigImpl extends MbspPsiCompositeElementBase implements MbspTypeHandlerConfig {

  public MbspTypeHandlerConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
