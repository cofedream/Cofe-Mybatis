...
public class MbspJavaTypeConfigImpl extends MbspPsiCompositeElementBase implements MbspJavaTypeConfig {

  public MbspJavaTypeConfigImpl(@NotNull ASTNode node) {
    super(node);
  }
