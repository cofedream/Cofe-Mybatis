 ...
 * @date : 2021-03-06
 */
public class MOgnlIdentifierReference extends PsiReferenceBase<PsiElement> {
    private final String prefixStr;
    private final PsiClass psiClass;
    private final PsiMethod psiMethod;

    public MOgnlIdentifierReference(@NotNull PsiElement element, final TextRange rangeInElement, String prefixStr, PsiMethod psiMethod) {
