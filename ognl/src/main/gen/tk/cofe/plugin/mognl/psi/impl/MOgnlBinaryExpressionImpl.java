...
public class MOgnlBinaryExpressionImpl extends MOgnlExpressionImpl implements MOgnlBinaryExpression {

  public MOgnlBinaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MOgnlExpression getLeft() {
  ...
  @Override
  @Nullable
  public MOgnlExpression getRight() {
    List<MOgnlExpression> p1 = PsiTreeUtil.getChildrenOfTypeAsList(this, MOgnlExpression.class);
    return p1.size() < 2 ? null : p1.get(1);
  }

  @Override
  public @NotNull MOgnlTokenType getOperator() {
    return MOgnlPsiUtil.getOperator(this);
  }
