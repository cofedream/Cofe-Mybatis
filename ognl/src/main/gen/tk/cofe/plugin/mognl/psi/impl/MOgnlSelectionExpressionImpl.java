...
public class MOgnlSelectionExpressionImpl extends MOgnlExpressionImpl implements MOgnlSelectionExpression {

  public MOgnlSelectionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MOgnlExpression getSelectorExpression() {
