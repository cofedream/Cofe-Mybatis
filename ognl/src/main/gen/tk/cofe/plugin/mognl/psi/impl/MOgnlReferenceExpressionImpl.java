...
public class MOgnlReferenceExpressionImpl extends MOgnlReferenceExpressionBase implements MOgnlReferenceExpression {

  public MOgnlReferenceExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MOgnlExpression> getExpressionList() {
