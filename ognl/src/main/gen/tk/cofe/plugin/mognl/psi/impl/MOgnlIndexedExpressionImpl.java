...
public class MOgnlIndexedExpressionImpl extends MOgnlExpressionImpl implements MOgnlIndexedExpression {

  public MOgnlIndexedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MOgnlExpression getReferenceQualifier() {
  ...
  @Override
  @Nullable
  public MOgnlExpression getIndexExpression() {
    List<MOgnlExpression> p1 = PsiTreeUtil.getChildrenOfTypeAsList(this, MOgnlExpression.class);
