...
public class MOgnlVariableExpressionImpl extends MOgnlVariableExpressionBase implements MOgnlVariableExpression {

  public MOgnlVariableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
