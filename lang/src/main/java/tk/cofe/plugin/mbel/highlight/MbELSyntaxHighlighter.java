...
import tk.cofe.plugin.mbel.psi.MOgnlTokenGroups;
 ...
 * @date : 2021-02-25
 */
public class MbELSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    static {
        KEY_MAP = new HashMap<>();
        fillMap(KEY_MAP, MOgnlTokenGroups.PARAM_CONFIG_KEYWORDS, KEYWORDS);
    }

    @Override
    public @NotNull Lexer getHighlightingLexer() {
        return new MbELHighlightingLexer();
    }
